...
public class H_sapiens_genome_visualizer extends PApplet {
...
public void draw() {
  ...
  if(line > end){
    plot.save(folder+"plot"+plotCounter+"_"+PApplet.parseInt(plotPos.x)+"_"+PApplet.parseInt(plotPos.y) +".png");
    exit();
  }
...
public PVector mapPos(char c) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "H_sapiens_genome_visualizer" };
    if (passedArgs != null) {
